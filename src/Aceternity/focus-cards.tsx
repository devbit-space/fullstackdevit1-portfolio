...
export const Card = React.memo(
  ({
    ...
    >
      ...
      >
        <div className="text-xl md:text-2xl font-medium bg-clip-text text-base bg-gradient-to-b from-neutral-50 to-neutral-200">
          {card.title}
        </div>
      </div>
    </div>
...
export function FocusCards({ cards }: { cards: Card[] }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mx-auto md:px-8 w-full">
